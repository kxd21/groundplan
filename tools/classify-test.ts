...
expect('Cocktail Round 30"', 'table-round');
expect('Highboy 30"', 'table-round');
expect('Chiavari Chair', 'chair');
expect('Banquet Chair 18" × 20"', 'chair');
expect('Banquet 6′ × 30″', 'table-rect');
expect('Folding Chair', 'chair');
expect('Barstool', 'chair');
