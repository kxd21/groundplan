...
export const COMMAND_CATALOG: CommandDef[] = [
  ...
  },
  {
    ...
    section: 'View',
    keywords: ['sv', 'elevation'],
    when: (c) => c.hasDoc && c.workspace === 'plan',
  },
  {
    id: 'isolation.exit',
    title: 'Exit solo / isolation',
    section: 'View',
    keywords: ['solo', 'dim', 'focus'],
    when: (c) => c.hasDoc && c.workspace === 'plan',
  },
  {
    id: 'seating.variant-save',
    title: 'Save seating layout variant',
    section: 'Show',
    keywords: ['kit', 'layout', 'variant'],
